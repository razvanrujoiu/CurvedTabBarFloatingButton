#
#  Be sure to run `pod spec lint CurvedTabBarFloatingButton.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://EXAMPLE/CurvedTabBarFloatingButton"
  ...
  spec.homepage = 'https://github.com/razvanrujoiu/CurvedTabBarFloatingButton'
  ...
  spec.author             = { "Razvan Rujoiu" => "rjrazvan@icloud.com" }
  # Or just: spec.author    = "Razvan Rujoiu"
  spec.authors            = { "Razvan Rujoiu" => "rjrazvan@icloud.com" }
  # spec.social_media_url   = "https://twitter.com/Razvan Rujoiu"
